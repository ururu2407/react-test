...
import { PalindromeCheckerProgram } from './program';
import { PalindromeCheckerDescription } from './description';
import { PalindromeCheckerCode } from './code';
                    ...
                    <CustomTab label={
                        <Box textTransform='none' display='flex' alignItems={'center'} width={'100%'} justifyContent={'space-between'}>
                            <Box display='flex' gap='16px' alignItems={'center'}>
                                ...
                                <Typography className='custom-second-label' variant='body'>Palindrome Checker</Typography>
                            </Box>
